...
export default function Nav() {
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 bg-[#fafaf8]/90 backdrop-blur-sm border-b border-[#e5e5e3]"
    >
      <div className="max-w-6xl mx-auto w-full px-8 md:px-16 lg:px-24 py-6 flex items-center justify-between">
